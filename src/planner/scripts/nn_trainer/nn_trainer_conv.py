...
class NNTrainer():
    ...
    def train_net(self):
        ...
        for epoch in range(EPOCHS):
            ...
            for i, data in enumerate(self.train_dataloader, 0):
                ...
                # forward
                outputs = self.planner_net(inputs)  # or planner_net.forward(inputs), they are the same
            ...
            # record the training loss of this epoch, the loss is the average loss of each batch
    ...
    def save_onnx_model(self):
        dummy_input = torch.randn(1, IMG_WIDTH*IMG_HEIGHT+MOTION_INPUT_SIZE)
